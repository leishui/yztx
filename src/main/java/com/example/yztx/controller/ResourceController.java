...
public class ResourceController {
     ...
     * @return {"status":200,"msg":"?id=3&name=156532545270.jpeg"，"content":null}
     * @catalog 与子同行/文件资源
     * @title 上传文件
     ...
     * showdoc
     *
     * @param files 必选 MultipartFile[] 所要上传的多个文件
     * @param up_id 必选 Long 上传者id
     * @return {"status":200,"msg":"["?id=3&name=156532545270.jpeg","?id=3&name=156532545270.jpeg"]"，"content":null}
     * @catalog 与子同行/文件资源
     * @title 上传多个文件
     * @description 上传多个文件到服务器
     * @method post
     * @url resource/upload_files
     * @return_param status int 成功与否
     * @return_param msg String 成功则返回文件资源url，失败则返回失败原因
     */
